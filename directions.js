...
const FETCH_DATA = new FetchData(() => `${SETTINGS.url}route?dimension=${SETTINGS.dimension}&startStation=${stationStart}&endStation=${stationEnd}`, DATA_REFRESH_INTERVAL * 1000000, false, () => shouldFetch && stationStart !== 0 && stationEnd !== 0 && stationStart !== stationEnd, data => {
